              ...
              <div className="p-4 rounded-xl bg-slate-950/80 border border-white/10 space-y-3">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  <div className="relative w-full sm:w-80">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded-lg pl-9 pr-3 py-1.5 text-xs text-white placeholder-slate-400 focus:outline-none focus:border-indigo-500"
                    />
                    {modalSearching && (
                    ...
                    {modalSearchResults.length > 0 && (
                      <div className="absolute z-20 mt-1 w-full bg-slate-900 border border-slate-700 rounded-lg shadow-2xl max-h-48 overflow-y-auto divide-y divide-slate-800">
                ...
                <div className="flex flex-wrap items-center gap-2 pt-2">
                  {compareData.map(c => (
                    <span
                      key={c.id}
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-indigo-950 text-indigo-200 border border-indigo-800 shadow-sm"
                    >
                ...
                <div className="flex flex-wrap items-center gap-1.5 pt-1 text-xs text-slate-300">
                  ...
                  {[
                    ...
                    <button
                      ...
                      className="px-2 py-0.5 rounded-md bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white border border-slate-800 transition-colors flex items-center gap-1 text-xs"
                    >
              ...
              {loadingCompare ? (
                ...
                <div className="overflow-x-auto border border-white/10 rounded-xl">
                  <table className="w-full text-xs text-left">
                    <thead className="bg-slate-950/90 text-slate-300 uppercase tracking-wider border-b border-white/10">
                      <tr>
